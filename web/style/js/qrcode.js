function createQRCode(ele, url, fav, wid, hei) {
    $("#" + ele).qrcode({
...
let QRMode = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, QRErrorCorrectLevel = {
    L: 1,
    M: 0,
    Q: 3,
    H: 2
}, QRMaskPattern, QRUtil, QRMath, i;
for (function (a) {
